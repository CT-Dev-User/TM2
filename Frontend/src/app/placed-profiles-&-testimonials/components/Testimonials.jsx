...
const Testimonials = () => {
  return (
    <div className="w-full h-auto my-10 py-8 bg-black">
                  ...
                  <div className=" w-1/2 flex flex-col gap-6 p-3">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-md pt-1">
                        ...
                        delivering IT outsourcing services worldwide. We combine
                        business domain knowledge, proven methodologies, We
                        combine business domain knowledge, proven methodologies,
                      </p>
                    </div>
