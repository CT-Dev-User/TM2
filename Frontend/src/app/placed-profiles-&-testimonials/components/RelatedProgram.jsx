        ...
        <div className="w-full flex justify-between items-center gap-3 ">
          {cardData.map((cd, index) => {
            return (
              <div
                key={index}
                className="w-1/4 h-[300px] flex flex-col gap-2 rounded-lg overflow-hidden border-[1px] border-slate-300"
              >
                ...
                <div className="pt-1 px-2">
                  <h1 className="text-2xl text-[#0466C1] font-semibold ">
                  ...
                  <div className="flex flex-wrap justify-between text-[#03006D] my-4">
                    <div className="flex gap-1 w-auto">
                      <Image src={"/file-blue.png"} width={20} height={20} alt="file-blue"/>
                      <p className="text-[12px]">Boot camp</p>
                    </div>
                    <div className="flex gap-1">
                      <Image src={"/blue-star.png"} width={20} height={20} alt="blue-star-Img"/>
                      <p className="text-[12px]">Placement Assistance</p>
                    </div>
                    <div className="flex gap-3 mt-3">
                      <Image src={"/calender.png"} width={20} height={20} alt="calenderImg"/>
