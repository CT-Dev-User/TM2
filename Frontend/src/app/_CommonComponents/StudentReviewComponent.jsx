...
const StudentReviews = ({ heading, isSubHeading }) => {
  ...
  return (
    <div id="testimonial"
      className={`w-full self-stretch flex flex-col justify-center my-10 box-border max-w-full text-left p-3`}
    >
      <div className="w-[80%] mx-auto">
        <div className="w-[100%] mb-8">
          ...
          {isSubHeading ? (
            <p className="uppercase text-[#0466C1] font-semibold ">
              What Student are saying about us
            </p>
          ) : null}
        </div>
      </div>
